  ...
  return (
    <div className="modal-backdrop">
      <div className="warning-dialog">
        ...
        <p>
          <span>Warning: </span>you have unsaved changes on this page. Are you
          sure you want to leave this page?
        </p>
        <div className="dialog-buttons">
          <button className="stay-btn" onClick={stayOnPage}>
            Stay on this page
          </button>
          <button className="leave-btn" onClick={leavePage}>
            Leave this page
          </button>
        </div>
      </div>
