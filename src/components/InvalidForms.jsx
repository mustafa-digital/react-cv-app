...
export function InvalidForms({
  ...
  return (
    <div className="section-border">
      <h3>
        Some of the information is incomplete. Please re-check the forms by
        clicking the links.
      </h3>
      ...
      {!educationIsValid && <Warning formName={"Education"} page={EDUCATION} />}

      {!workIsValid && <Warning formName={"Work"} page={WORK} />}
    </div>
  );
}
